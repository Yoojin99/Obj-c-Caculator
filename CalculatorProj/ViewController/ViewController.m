...
//    sLayout.estimatedItemSize = UICollectionViewFlowLayoutAutomaticSize;
    ...
    _buttonTexts = @[
        [[NumberCharacter alloc] initWithText:@"0"],
        [[NumberCharacter alloc] initWithText:@"1"],
        [[NumberCharacter alloc] initWithText:@"2"],
        [[NumberCharacter alloc] initWithText:@"3"],
        [[NumberCharacter alloc] initWithText:@"4"],
        [[NumberCharacter alloc] initWithText:@"5"],
        [[NumberCharacter alloc] initWithText:@"6"],
        [[NumberCharacter alloc] initWithText:@"7"],
        [[NumberCharacter alloc] initWithText:@"8"],
        [[NumberCharacter alloc] initWithText:@"9"],
        [[OperandCharacter alloc] initWithText:@"+"],
        [[OperandCharacter alloc] initWithText:@"-"],
        [[OperandCharacter alloc] initWithText:@"x"],
        [[OperandCharacter alloc] initWithText:@"/"],
        [[FunctionCharacter alloc] initWithText:@"Enter"], //
        [[FunctionCharacter alloc] initWithText:@"Del" andButtonOperation:[DeleteButtonOperation new]],
        [[FunctionCharacter alloc] initWithText:@"C" andButtonOperation:[ClearButtonOperation new]],
    ];
}
...
- (nonnull __kindof UICollectionViewCell *)collectionView:(nonnull UICollectionView *)collectionView cellForItemAtIndexPath:(nonnull NSIndexPath *)indexPath {
    ...
    sCell.character = [_buttonTexts objectAtIndex:indexPath.row];
    sCell.buttonTextLabel.text = sCell.character.text;
...
- (void)collectionView:(UICollectionView *)collectionView didSelectItemAtIndexPath:(NSIndexPath *)indexPath {
   ButtonCollectionViewCell* cell = (ButtonCollectionViewCell*) [collectionView cellForItemAtIndexPath:indexPath];
    ...
    self.printLabel.text = [cell.character.buttonOperation buttonPush:self.printLabel.text withText:cell.character.text];
...
- (CGSize)collectionView:(UICollectionView *)collectionView layout:(UICollectionViewLayout*)collectionViewLayout sizeForItemAtIndexPath:(NSIndexPath *)indexPath {
        return CGSizeMake((collectionView.frame.size.width)/3, (collectionView.frame.size.width)/4); // cell 하나의 크기
